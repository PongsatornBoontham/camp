...
<body>
    ...
    ชื่อ : <?php echo $obj_student->prefix_name . $obj_student->student_firstname . " " . $obj_student->student_lastname ?> <br><br>
    ...
    <img src="<?php echo base_url() . '/picture/' . $obj_student->student_image_name ?>" width= "500" height= "375">
